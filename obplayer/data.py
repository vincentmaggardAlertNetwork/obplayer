...
class ObConfigData (ObData):
    ...
    def check_defaults(self):
        ...
        for i in range(2):
            ...
            self.add_setting('streamer_' + i + '_icecast_mount', 'stream_2', 'text')
            self.add_setting('streamer_' + i + '_icecast_password', '1c3c4stS0uRc3', 'text')
            self.add_setting('streamer_' + i + 'icecast_streamname', '', 'text')
            self.add_setting('streamer_' + i + 'icecast_description', '', 'text')
            self.add_setting('streamer_' + i + 'icecast_url', '', 'text')
            self.add_setting('streamer_' + i + 'icecast_public', '0', 'bool')
